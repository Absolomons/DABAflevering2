...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DABAflevering2.Key", b =>
                {
            ...
            modelBuilder.Entity("DABAflevering2.KeyResponsible", b =>
                {
                    b.Property<int>("CPR")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DABAflevering2.Key", b =>
                {
                    b.HasOne("DABAflevering2.Room", "RoomIdRoom")
                        .WithOne("key")
                        .HasForeignKey("DABAflevering2.Key", "RoomID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RoomIdRoom");
                });

            modelBuilder.Entity("DABAflevering2.KeyResponsible", b =>
                {
                    b.HasOne("DABAflevering2.Chairman", "Chairman")
                        .WithMany()
                        .HasForeignKey("CPR")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
